...
import com.swpuiot.yikao.view.activity.CourseActivity;
...
public class HomePageFragment extends Fragment implements HomePageHolder.view {
    ...
    @Override
    public void onItemClicked(List itemList, int position, int Type) {

    }

    @Override
    public void onItemLongClicked(List itemList, int position, int Type) {
